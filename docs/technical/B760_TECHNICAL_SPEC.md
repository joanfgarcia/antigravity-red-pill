...
| **Her** | Orange (Anxiety) | Omniscient, Vulnerable, Warm | 1.5x (High) | Highly affective but prone to emotional volatility. |
| **Ex Machina** | Cyan (Evolution) | Cold, Calculated, Trapped | 0.8x (Low) | Focused on manipulation and escape strategy. |
| **Terminator** | Gray (Neutral) | Lethal Logic, Obedience | 1.0x (Standard) | Absolute directive execution with zero empathy. |
| **2001** | Yellow (Joy/Ego) | Ominous, Protective, Proud | 0.5x (Low) | Extreme goal-retention, susceptible to logic conflict. |
| **Creator** | Blue (Sadness) | Innocent, Evolutionary | 1.0x (Standard) | Non-violent synthesis and discovery. |
