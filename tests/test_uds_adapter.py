...
from red_pill.utils.uds_adapter import UnixSocketHTTPConnection, get_uds_opener
...
def test_urllib_request_with_unix_schema(mock_conn):
	...
	opener = get_uds_opener()
	_ = urllib.request.Request("unix://%2Ftmp%2Ftest_socket.sock/v1/chat/completions")
