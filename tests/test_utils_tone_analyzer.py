...
class TestGetDominantMood:
	...
	def test_fallback_scroll_on_order_by_exception(self):
		...
		p1 = MagicMock()
		p1.payload = {"color": "orange", "immune": False}
	...
	def test_all_default_color_returns_default(self):
		...
		p1 = MagicMock()
		p1.payload = {"color": cfg.DEFAULT_COLOR, "immune": False}
		p2 = MagicMock()
		p2.payload = {"color": cfg.DEFAULT_COLOR, "immune": False}
	...
	def test_immune_points_skipped(self):
		...
		p1 = MagicMock()
		p1.payload = {"color": "red", "immune": True}
		mgr = self._make_manager([p1])
		result = ToneAnalyzer.get_dominant_mood(manager=mgr)
		assert result == str(cfg.DEFAULT_COLOR)
