...
async def test_local_compression():
	...
	verbose_text = "Hola JARVIS, necesito que por favor revises el código de la base de datos porque creo que hay un problema con la persistencia cuando se reinicia el sistema. Básicamente lo que pasa es que los datos no se guardan correctamente en el disco y me gustaría saber si podrías proponer una solución técnica para esto."
