...
from red_pill.utils.affect import calculate_fsrs_retrievability, calculate_fsrs_new_stability
...
def test_memory_management_coverage_gaps(tmp_path):
    ...
    with patch.object(mem_mgr.client, "scroll", return_value=([MagicMock(id="1", payload={"content": "x" * (cfg.CHUNK_THRESHOLD + 1), "reinforcement_score": 1.0, "color": "blue", "emotion": "joy", "intensity": 1.0, "immune": False})], None)):
