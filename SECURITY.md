...
The current actively maintained and supported version of the Red Pill Protocol is **`v6.7.0`**. The v6.x family receives security patches and bug fixes. All v5.x and earlier releases are **End-of-Life (EOL)** and may contain known vulnerabilities.

| Version | Supported          | Notes |
| ------- | ------------------ |-------|
| 6.7.x   | :white_check_mark: | Current Phoenix / Stable branch |
| 6.6.x   | :x:                | EOL. Please upgrade to 6.7 |
| < 6.5   | :x:                | EOL. |
