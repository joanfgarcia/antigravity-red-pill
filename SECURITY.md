...
The current actively maintained and supported version of the Red Pill Protocol is **`v7.5.0`**. The v7.x family receives security patches and bug fixes. All v6.x and earlier releases are **End-of-Life (EOL)** and may contain known vulnerabilities.

| Version | Supported          | Notes |
| ------- | ------------------ |-------|
| 7.5.x   | :white_check_mark: | Current Sovereign Set Point / Stable branch |
