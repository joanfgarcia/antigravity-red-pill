...
def audit_collection(collection_name: str, md_file):
	try:
		...
		for p in points:
			...
			if is_suspicious:
				md_file.write("> [!WARNING] ALARMA - Posible Alucinación de Qwen detectada\n")
			else:
				md_file.write("> [!TIP] Aparentemente limpio/normal\n")
...
def main():
	...
	with open(out_path, "w", encoding="utf-8") as f:
		...
		f.write(
			"A continuación se listan los engramas activos en tus colecciones nobles. Revisa los IDs marcados como `WARNING` por contexto sospechoso:\n\n"
		)
