...
def main():
	...
	for config in configs:
		...
		for case in test_cases:
			...
			# Limpiar saltos de línea de la respuesta para imprimir
	...
	with open(report_path, "w", encoding="utf-8") as f:
		...
		f.write(
			"Este reporte compara cuantitativa y cualitativamente los diferentes modos de backtracking y sus umbrales sobre el modelo Falcon-3B.\n\n"
		)
