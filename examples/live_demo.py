...
async def main():
	...
	gru = GruOrchestrator()
	print("[*] Orquestador GRU en línea.")
	...
	results = await gru.deploy_swarm(task="Auditar código fuente y buscar referencias a Antigravity en memoria", minions=[oracle, smith], path=".")
