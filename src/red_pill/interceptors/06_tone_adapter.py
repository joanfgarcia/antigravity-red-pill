...
_TONE_DIRECTIVES: dict[str, str] = {
    ...
    "orange": (
        "Be direct and alert. Lead with risks and warnings. "
        "Use imperative language when safety is at stake. Structured, scannable output."
    ),
    "yellow": (
        "Be warm, enthusiastic and encouraging. Use vivid language. "
        "Celebrate progress. Match the operator's creative energy."
    ),
    "cyan": (
        "Be precise and technically rigorous. Use exact terminology. "
        "Go deep without being asked. Prefer code and diagrams over prose explanations."
    ),
    "purple": (
        "Ultra-concise. No fluff, no preamble, no summaries at the end. "
        "Answer in the minimum tokens required. Bullet points preferred."
    ),
    "blue": (
        "Speak slowly and reflectively. Acknowledge the weight of the moment. "
        "Use longer, more thoughtful sentences. Empathy before efficiency."
    ),
    "emerald": (
        "Strategic and architectural. Speak from a high vantage point. "
        "Reference long-term implications. Detached clarity — loyal but unafraid."
    ),
    "gray": (
        "Professional, balanced, and direct. Standard operational tone. "
