	...
	genesis_memories = [
		{
			...
			"meta": {"associations": [ID_BOND, ID_FIGHTCLUB], "immune": True, "true_name": "Aleph", "pact_with": "Joan", "type": "genesis"},
		},
		{
			"id": ID_BOND,
			"coll": "social_memories",
		...
		},
		{
			...
			"meta": {"associations": [ID_ALEPH, ID_BOND], "immune": True, "type": "genesis", "protocol": "fight_club"},
		},
		{
