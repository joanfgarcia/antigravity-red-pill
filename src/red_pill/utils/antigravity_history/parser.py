...
def _parse_planner_response(step: dict, include_thinking: bool, include_full: bool) -> Optional[dict]:
...
def _parse_run_command(step: dict, include_thinking: bool, include_full: bool) -> Optional[dict]:
